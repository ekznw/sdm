...
flowchart TD
    ...
    DecisionPoint -->|Option 3:<br/>Full modelling| SDMAnalysis[Species Distribution<br/>Model Analysis]
    
    SpeciesRecordsDB -->|Query species<br/>traits & groups| SpeciesTraits[Species Traits<br/>& Group Data]
